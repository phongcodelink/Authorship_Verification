...
class BaseConfig:
    ...
    def add_path(self) -> None:
        ...
        self.parser.add_argument("--raw_data_dir", type=str,
                                 default=Path(__file__).parents[2].__str__() + "/data/AV_processed_v5")
        ...
        self.parser.add_argument(
            ...
            default="/content/drive/Shareddrives/LEAP_hivemind/Fraud_detection/data/one-one_conversations/AV_processed/T5/Authorship_Verification/assets/saved_models/Author_Verification/version_6/checkpoints/QTag-epoch=02-val_acc=1.00.ckpt")
